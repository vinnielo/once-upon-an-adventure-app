        ...
        <div className="col-md-6">
          <div className="card text-center">
            <div className="card-body special">
              ...
              <p>
                Once Upon an Adventure is an interactive learning game. From
                this menu you can continue a previous Adventure (if you have one
                saved), or start a new Adventure. Enjoy your time exploring the
                word we've created for you!
              </p>
