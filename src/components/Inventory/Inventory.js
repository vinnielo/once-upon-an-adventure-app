...
function Inventory(props) {
  ...
  useEffect(() => {
    ...
    const getUserData = async ()=> {
        ...
        const { lives, permit } = user.sprite[0];
  ...
  function heart() {
    if (userLives === 3) {
      return (
        <img
          src={require("../../images/threeHearts.png")}
          className="heart-three"
          alt="Heart Bar"
        />
      );
    } else if (userLives === 2) {
      return (
        <img
          src={require("../../images/twoHearts.png")}
          className="heart-two"
          alt="Heart Bar"
        />
      );
      ...
      return (
        <img
          src={require("../../images/oneHeart.png")}
          className="heart-one"
          alt="Heart Bar"
        />
      );
  ...
  function permit() {
    if (userPermit === true) {
      return (
        <img
          src={require("../../images/castle-pass.png")}
          className="invtImg"
          alt="Castle Pass"
        />
      );
